    ...
    return (e => {
        ...
        function f(e, t, s, l) {
            ...
            function x(n, a) {
                ...
                if ("end" === a.type) { const e = b(a); if (e !== V) return e }
        ...
        "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
            ...
            highlightBlock: e => (z("10.7.0", "highlightBlock will be removed entirely in v12.0"),
                z("10.7.0", "Please use highlightElement now."), x(e)),
            configure: e => {
...
hljs.registerLanguage("julia-repl", (() => {
    ...
    return a => ({
        name: "Julia REPL",
        contains: [{ className: "meta", begin: /^julia>/, relevance: 10, starts: { end: /^(?![ ]{6})/, subLanguage: "julia" }, aliases: ["jldoctest"] },
...
hljs.registerLanguage("xml", (() => {
    ...
    function a(...n) { return n.map((n => e(n))).join("") }
...
hljs.registerLanguage("yaml", (() => {
    ...
    return e => {
        var n = "true false yes no null",
            ...
            }, { className: "number", begin: e.C_NUMBER_RE + "\\b", relevance: 0 }, t, g, s],
            r = [...b];
